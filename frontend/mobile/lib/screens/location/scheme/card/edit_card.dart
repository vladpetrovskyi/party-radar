...
import 'package:party_radar/screens/location/scheme/card/table_widget.dart';
...
class _EditCardPageState extends State<EditCardPage> with ErrorSnackBar {
  ...
  List<Widget> get _cardDialogSettings {
    final TextEditingController dialogNameController =
        TextEditingController(text: _location.dialogName);
    return [
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              FilledButton.tonal(
                                onPressed: () {
                                  ImageService.delete(_location.imageId!).then(
                                      (deleted) => deleted
                                          ? setState(
                                              () => _location.imageId = null)
                                          : showErrorSnackBar(
              ...
              child: Center(
                child: FilledButton(
                    onPressed: () async {
                      ...
                      if (imageId == null) {
                        showErrorSnackBar(
                            "Could not add image, please try again", context);
                        return;
                      }
  ...
  void _showDeleteCardDialog() => showDialog(
        context: context,
  ...
  DialogSettings get dialogSettings => DialogSettings(
